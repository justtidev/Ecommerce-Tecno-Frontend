        ...
        <Box display="flex" flexDirection="" alignItems="right">
          ...
          <Box id="Contacto" display="flex" justifyContent="space-around" width="100%" flexWrap="wrap">
            ...
            <Box mb={2} textAlign="center">
              ...
              <Typography variant="h6" sx={{ color: 'black', fontWeight: '' }}>Tel: 11593-2190 </Typography>
              <Typography variant="h6" sx={{ color: 'black', fontWeight: 'b' }}>Av.San Martin 900, Cordoba </Typography>
            </Box>
            ...
            <Box mb={2} textAlign="center">
              ...
              <div className='flex justify-center gap-4'>
                <a href="https://www.facebook.com/" target="_blank"  >
                  <svg class="header--custom-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <Box mb={2} textAlign="center">
              ...
              <Link href="#" color="inherit" sx={{ display: 'block', color: 'black', '&:hover': { textDecoration: 'underline', color: '#C68CBA' } }}>Terminos y condiciones</Link>
