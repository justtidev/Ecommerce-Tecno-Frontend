...
const Filter2 = ({
  ...
  const [categoriaSeleccionadaLocal, setCategoriaSeleccionadaLocal] =
    useState("");
  ...
  return (
    <>
      <div className=" grid gap-y-8">
        <Accordion
          className=" w-auto text-center border-2  shadow-slate-600 shadow-xl  "
          /* border-gray-200  focus:outline-none focus:ring-gray-600 focus:border-gray-800 */ sx={{
            backgroundColor: " ",
            borderColor: "",
            borderRadius: "8px",
            borderWidth: "1px",
        ...
        >
          <AccordionSummary
            className=" shadow-slate-600 shadow-lg   p-2"
            expandIcon={<ExpandMoreIcon sx={{ fontSize: 8 }} />}
          >
        ...
        <button
          className="btn w-auto p-2 rounded-md  "
          type="button"
