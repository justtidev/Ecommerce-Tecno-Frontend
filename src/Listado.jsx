  ...
  return (
    <>
          ...
          <div className="ml-20 max-w-4xl px-4 py-2 sm:px-6  lg:max-w-7xl lg:px-8">
            ...
            <div id="Productos" className="mt-2 grid grid-cols-3  gap-x-6 gap-y-6 sm:grid-cols-1 sm:gap-x-4 lg:grid-cols-3  xl:gap-x-8">
                 ...
                 <div className="">
                  ...
                  {/* <div className=" flex flex-col-1 "> */}
                    <div className='grid' >
                      ...
                      <button onClick={() => handleVerDetalles(producto.id)} className='underline' >Mas detalles</button>
